...
func ParseOptions() (Options, error) {
	options := Options{
		...
		BrowserPath:       flag.String("browser-path", "", "Full path to the Chrome/Chromium/Edge executable to use. By default, aquasily will search for Chrome or Chromium"),
		...
		ScreenshotTimeout: flag.Int("screenshot-timeout", 10*1000, "Timeout in milliseconds for screenshots"),
