...
func ParseOptions() (Options, error) {
	options := Options{
		...
		ScreenshotTimeout:    flag.Int("screenshot-timeout", 15, "Timeout in seconds for screenshots"),
		...
		ReferenceScreenshots: flag.String("ref-screenshots", "", "Path to screenshots for comparison"),
	}
	flag.Parse()
	return options, nil
}
